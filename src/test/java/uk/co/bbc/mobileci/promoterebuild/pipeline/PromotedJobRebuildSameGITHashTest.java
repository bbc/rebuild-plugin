...
public class PromotedJobRebuildSameGITHashTest {
    ...
    @Test
    public void promotingCommitNotFromHeadUsesPipelineScriptNotFromHeadWhenLightweightCheckoutIsOff() throws Exception {
    ...
    @Test
    public void promotingCommitNotFromHeadUsesPipelineScriptFromHeadWhenLightweightCheckoutIsOn() throws Exception {
